...
import com.fionapet.tenant.TcApp;
...
@SpringBootTest(classes = TcApp.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@EnableAutoConfiguration
@Setter
@Slf4j
public class PublicMarketTest {

    Logger logger = LoggerFactory.getLogger(PublicMarketTest.class);
